"""A5: full ablation of original CSG, not the fusion/FiLM variants.
...
MODEL_SPEC = {'name': 'CSG_A5_full',
 'description': 'Original CSG ablation: full; learnable gate strength initialized to '
                '1.',
...
class ConvLSTMLsTopographyJointGatedSimVP(nn.Module):
    ...
    def forward(self, x, ls, topography):
        ...
        gated, _, _ = self.joint_gate(encoded, ls=ls, topography=topography)
