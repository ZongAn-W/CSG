"""A1: unchanged ConvLSTM-SimVP baseline; no conditional gate."""
import torch
from torch import nn


MODEL_SPEC = {'name': 'CSG_A1_Baseline',
 'description': 'ConvLSTM temporal features followed by a lightweight SimVP '
