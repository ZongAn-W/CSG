"""A2: dynamic ablation of original CSG, not the fusion/FiLM variants.
...
MODEL_SPEC = {'name': 'CSG_A2_dynamic',
 'description': 'Original CSG ablation: dynamic; learnable gate strength initialized '
                'to 1.',
...
class ConvLSTMLsTopographyJointGatedSimVP(nn.Module):
    ...
    def forward(self, x):
        ...
        gated, _, _ = self.joint_gate(encoded, ls=None, topography=None)
