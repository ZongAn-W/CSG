"""Dynamic-topography gate before ConvLSTM.
...
MODEL_SPEC = {'name': 'CSG_GateBeforeConvLSTM',
 'description': 'Dynamic-topography gate before ConvLSTM.',
...
class ConvLSTMBeforeInputGatedSimVP(nn.Module):
    def __init__(
        ...
        self.joint_gate = DynamicTopographyGate(
            in_channels, gate_hidden_dim, initial_gate_strength,
        )
    ...
    def forward(self, x, topography):
        ...
        x, _, _ = self.joint_gate(x, topography)
...
def build_model(config):
    ...
    return ConvLSTMBeforeInputGatedSimVP(
